...
> On `n2` and `n3`, set `ETCD_NAME` to `n2` / `n3` respectively, and update the `*_URLS`
> values to use that node's own IP (e.g. `10.0.0.2`, `10.0.0.3`). `ETCD_INITIAL_CLUSTER`
> remains identical across all three nodes.

---

Previous: [1. Base Preparation](01-base-preparation.md) | Next: [3. Install PostgreSQL + Patroni](03-postgresql-patroni.md)

...
The `etcd3.hosts`, `bootstrap`, and `authentication` sections are identical across all nodes.

---

Previous: [3. Install PostgreSQL + Patroni](03-postgresql-patroni.md) | Next: [5. Create Patroni systemd Service](05-patroni-service.md)

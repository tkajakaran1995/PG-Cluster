# 7️⃣ Configure Keepalived VIP

![Scope](https://img.shields.io/badge/scope-ON--PREM_ONLY-success?style=flat-square)
...
⬅️ Previous: [6. Install HAProxy + Keepalived](06-haproxy.md) | ➡️ Next: [8. Oracle Cloud (OCI) Variant](08-oci-variant.md)

# 8️⃣ Oracle Cloud (OCI) Variant — NLB instead of Keepalived

![Scope](https://img.shields.io/badge/scope-OCI_ONLY-F80000?style=flat-square&logo=oracle&logoColor=white)
![Component](https://img.shields.io/badge/component-Network_Load_Balancer-F80000?style=flat-square)

On OCI, replace [Section 7 (Keepalived)](07-keepalived.md) with an OCI Network Load
Balancer (NLB). Sections 1–6 are unchanged.

## ⏭️ 8.1 — Skip Keepalived
...
| 8008 | 🛡️ Patroni REST (health) | VCN CIDR `10.0.0.0/24` |
| 2379, 2380 | 🗳️ etcd | VCN CIDR `10.0.0.0/24` |
...
## ⚖️ 8.4 — Create the Network Load Balancer
...
|---|:---:|---|:---:|
| ✍️ Write (to primary) | TCP 5000 | n1/n2/n3 on port 5000 | TCP 5000 |
...
> So the NLB health check is simple TCP — it only confirms HAProxy is alive. The
> Patroni failover mechanism is completely unchanged from the on-prem setup.
...
⬅️ Previous: [7. Configure Keepalived VIP](07-keepalived.md) | ➡️ Next: [9. Verify & Test Failover](09-verify-failover.md)

# 9️⃣ Verify & Test Failover

![Scope](https://img.shields.io/badge/scope-VALIDATION-success?style=flat-square)
...
> [!NOTE]
> ☁️ On OCI, replace `10.0.0.100` with the OCI NLB's IP address.
...
- ✍️ Writes through port `5000` continue to reach the new primary **with no client
  reconfiguration**

---

⬅️ Previous: [8. Oracle Cloud (OCI) Variant](08-oci-variant.md) | ➡️ Next: [10. On-Prem vs OCI — What Changes](10-onprem-vs-oci.md)

...
- [ ] **Tuning** — set `shared_buffers` ≈ 25% RAM, `effective_cache_size` ≈ 75% RAM,
  and an appropriate `max_connections`.
- [ ] **Monitoring** — deploy Prometheus + `postgres_exporter` and watch Patroni / etcd
  health.
- [ ] **etcd disk** — keep etcd on low-latency SSD; etcd is highly sensitive to fsync
  latency.

---

Previous: [10. On-Prem vs OCI — What Changes](10-onprem-vs-oci.md) | Back to: [README](../README.md)
